...
Do not merge this branch into the parent checkout. Do not commit. Do not `git worktree remove`.
...
- Edit source in the primary checkout, merge the impl branch into another branch, or commit.
- Open a GitHub PR. The orchestrator does that after gates APPROVE.
